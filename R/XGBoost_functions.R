...
grid_search_xgboost <- function(data_xgboost,
                                config_env,
                                challenge) {
...
train_pred_xgboost_europe <- function(data_xgboost,
                                      large_data,
                                      config_models,
                                      config_env,
                                      challenge) {
...
train_pred_xgboost_one_country <- function(data_xgboost,
                                           config_models,
                                           config_env,
                                           challenge,
                                           country) {
...
run_grid_search_xgboost <- function(data,
                                    config_models,
                                    config_env,
                                    challenge,
                                    per_country,
