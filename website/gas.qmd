---
title: European inland gas consumption challenge
---
...
Gas consumption statistics are a key part of the system of energy statistics in the EU and have a long history of data collection.
For this indicator, the benchmark will be the official figures on Inland gas consumption in each European country.
...
targets::tar_load(predictions_gas, store = "store_gas")

sample <- data$GAS$data |>
  dplyr::filter((siec %in% "G3000"))

ojs_define(data = sample, pred = predictions_gas)
```
